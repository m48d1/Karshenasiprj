...
urlpatterns = [
    ...
    url(r'Dashboard/DelStudent', views.delstudent, name="DeleteStudent"),
    url(r'Dashboard/EditStudent', views.editstudent, name="EditStudent"),
    ...
    url(r'Dashboard/ListofStudent', views.listofstdpage, name="ListofStudents"),
